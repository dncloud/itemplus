  ...
  return (
    <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
      ...
      <button onClick={onOpenGalleryUpload} className={buttonClassName}>
        <ImageIcon className="mx-auto mb-3 h-8 w-8 text-gray-400 dark:text-gray-500" />
      ...
      <button onClick={onOpenLinkModal} className={buttonClassName}>
        <Link className="mx-auto mb-3 h-8 w-8 text-gray-400 dark:text-gray-500" />
      ...
      <button onClick={onOpenSftpModal} className={buttonClassName}>
        <Archive className="mx-auto mb-3 h-8 w-8 text-gray-400 dark:text-gray-500" />
