...
> = {
  link: { icon: Link, bg: "bg-blue-100 dark:bg-blue-900/20", color: "text-blue-500", label: "Link" },
  archive: { icon: Archive, bg: "bg-amber-100 dark:bg-amber-900/20", color: "text-amber-500", label: "Archive" },
  code: { icon: Code, bg: "bg-purple-100 dark:bg-purple-900/20", color: "text-purple-500", label: "Code" },
  video: { icon: Video, bg: "bg-pink-100 dark:bg-pink-900/20", color: "text-pink-500", label: "Video" },
  audio: { icon: Music, bg: "bg-green-100 dark:bg-green-900/20", color: "text-green-500", label: "Audio" },
  document: { icon: FileText, bg: "bg-gray-100 dark:bg-gray-800", color: "text-gray-400", label: "Datei" },
  image: { icon: Image, bg: "bg-gray-100 dark:bg-gray-800", color: "text-gray-400", label: "Bild" },
};
