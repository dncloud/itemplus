...
import { ArrowLeft, Upload, FileText, Folder, X } from "lucide-react";
import { attachmentFilename, fmtSize, IMAGE_EXTS } from "@/components/attachments/attachment-manager-utils";
                    ...
                    {browseEntries.map((entry) => (
                      ...
                      >
                        <div className="flex min-w-0 items-center gap-2">
                          {entry.is_dir ? <Folder className="h-4 w-4 shrink-0 text-blue-500" /> : <FileText className="h-4 w-4 shrink-0 text-gray-400" />}
                          <div className="min-w-0">
