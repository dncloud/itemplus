...
import { Camera, ChevronDown, ChevronRight, ChevronUp, QrCode, Sparkles } from "lucide-react";
import {
  AIDrawerTabs,
  AIDrawerChatMessage,
  AIRawDebugPanel,
...
import { BarcodeDraftNotice } from "@/components/item-create/ai-notices";
  ...
  return (
    <div className="mb-4 text-center sm:flex sm:items-center sm:justify-between sm:border-b sm:border-gray-200 sm:text-left lg:mb-8 dark:border-white/10">
      ...
      <div className="flex items-center justify-center gap-2 rounded-sm px-2 py-3 sm:justify-end sm:bg-transparent sm:px-0">
        ...
        >
          <Sparkles className={clsx("h-4 w-4", aiAssistBusy ? "animate-pulse" : "")} />
        </button>
        <Link
          href={cancelHref}
